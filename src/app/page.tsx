      ...
      <main className="w-[100vw] h-[100vh] flex">
        ...
        <section className='w-full h-full px-[20px] py-[50px] items-center justify-center flex'>
            <div className='grid grid-cols-4 grid-rows-3 gap-6'>
              ...
              corTexto2='text-zinc-800' corTexto3='text-zinc-800'/>
              
              <CardColors hexadecimalFrom='from-indigo-500' hexadecimalVia='via-sky-500' hexadecimalTo='to-emerald-500' hexadecimal1='#6366f1' hexadecimal2='#0EA5E9' 
              hexadecimal3='#10B981' hexadecimal1bg='bg-[#6366f1]' hexadecimal2bg='bg-[#0ea5e9]' hexadecimal3bg='bg-[#10b981]' corTexto1='text-zinc-800'
              corTexto2='text-zinc-800' corTexto3='text-zinc-800'/>
              
              <CardColors hexadecimalFrom='from-cyan-500' hexadecimalTo='to-blue-500' hexadecimal1='#06B6D4' 
              hexadecimal3='#3B82F6' hexadecimal1bg='bg-[#06B6D4]' hexadecimal3bg='bg-[#3B82F6]' corTexto1='text-zinc-800'
              corTexto2='text-zinc-800' corTexto3='text-zinc-800'/>
              
              <CardColors hexadecimalFrom='from-[#aa639c]' hexadecimalVia='via-[#803b74]' hexadecimalTo='to-[#55134b]' hexadecimal1='#aa639c' hexadecimal2='#803b74' 
              hexadecimal3='#55134b' hexadecimal1bg='bg-[#aa639c]' hexadecimal2bg='bg-[#803b74]' hexadecimal3bg='bg-[#55134b]' corTexto1='text-zinc-900'
              corTexto2='text-zinc-300' corTexto3='text-zinc-300'/>

              <CardColors hexadecimalFrom='from-[#c2de8c]' hexadecimalVia='via-[#b2ce7c]' hexadecimalTo='to-[#a2bd6d]' hexadecimal1='#c2de8c' hexadecimal2='#b2ce7c' 
              ...
              <CardColors hexadecimalFrom='from-[#ffd8d1]' hexadecimalVia='via-[#b08d87]' hexadecimalTo='to-[#60423d]' hexadecimal1='#ffd8d1' hexadecimal2='#b08d87' 
              ...
              <CardColors hexadecimalFrom='from-[#abae42]' hexadecimalTo='to-[#586000]' hexadecimal1='#abae42' 
              hexadecimal3='#586000' hexadecimal1bg='bg-[#abae42]' hexadecimal3bg='bg-[#586000]' corTexto1='text-zinc-900'
              corTexto3='text-zinc-100'/>        

              <CardColors hexadecimalFrom='from-[#cd2c18]' hexadecimalVia='via-[#ac1d10]' hexadecimalTo='to-[#8c0f08]' hexadecimal1='#cd2c18' hexadecimal2='#ac1d10' 
              hexadecimal3='#8c0f08' hexadecimal1bg='bg-[#cd2c18]' hexadecimal2bg='bg-[#ac1d10]' hexadecimal3bg='bg-[#8c0f08]' corTexto1='text-zinc-100'
              corTexto2='text-zinc-100' corTexto3='text-zinc-100'/>        

              <CardColors hexadecimalFrom='from-[#e08da9]' hexadecimalVia='via-[#b0627c]' hexadecimalTo='to-[#6c1c41]' hexadecimal1='#e08da9' hexadecimal2='#b0627c' 
              hexadecimal3='#6c1c41' hexadecimal1bg='bg-[#e08da9]' hexadecimal2bg='bg-[#b0627c]' hexadecimal3bg='bg-[#6c1c41]' corTexto1='text-zinc-900'
              corTexto2='text-zinc-100' corTexto3='text-zinc-100'/>        

              <CardColors hexadecimalFrom='from-[#ffffff]' hexadecimalVia='via-[#a0a0a0]' hexadecimalTo='to-[#393939]' hexadecimal1='#ffffff' hexadecimal2='#a0a0a0' 
              ...
              <CardColors hexadecimalFrom='from-[#fcbd57]' hexadecimalTo='to-[#df8c07]' hexadecimal1='#fcbd57' 
              hexadecimal3='#df8c07' hexadecimal1bg='bg-[#fcbd57]' hexadecimal3bg='bg-[#df8c07]' corTexto1='text-zinc-900'
              corTexto3='text-zinc-100'/>        

              <CardColors hexadecimalFrom='from-[#8c433c]' hexadecimalVia='via-[#5f211e]' hexadecimalTo='to-[#320000]' hexadecimal1='#8c433c' hexadecimal2='#5f211e' 
